...
import (
	...
	// nameconflict declares itself as `package deflog`.
	"github.com/u-root/gobusybox/vendortest/pkg/nameconflict"

	// anotherlog makes sure that a package can be imported twice with a different name.
	anotherlog "github.com/u-root/gobusybox/vendortest/pkg/nameconflict"
